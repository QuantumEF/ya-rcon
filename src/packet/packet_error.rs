...
/// The errors that can happen when working with a `Packet`
...
pub enum PacketError {
    ...
    InvalidPacketBody,
    /// The String payload exceded the `MAX_PAYLOAD_SIZE`
    InvalidPayloadLength,
    /// I am using this primarily in RCONClient. Maybe remove it from here and put elsewhere?
